...
const timeIntervalsTimeFormSchema = z.object({
  intervals: z
    .array(
      z.object({
    ...
    .refine((intervals) => intervals.length > 0, {
      message: 'Você precisa selecionar pelom menos um dia da semana!',
    })
    .transform((intervals) => {
...
type TimeIntervalsFormInput = z.input<typeof timeIntervalsTimeFormSchema>
type TimeIntervalsFormOutput = z.output<typeof timeIntervalsTimeFormSchema>
